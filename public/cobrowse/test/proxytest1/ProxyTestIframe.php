...
<link rel="shortcut icon" type="image/png" href="/favicon.ico" />
    ...
    <link rel="stylesheet" href="proxytest2/styles/styles4.css"/>
    <link rel="stylesheet" href="proxytest1/proxytest2/styles/styles2.css"/>
...
<div id="CrossOriginWarning">
  ...
  <div id="cbsettings" class="collapse aboxcontent">
    ...
    <div id="testheader" class="collapse">
        View this page:
        <ul id="modelinks">
        <li><a href="ProxyTestIframe.php">insecure, no parameters</a></li>
        <li><a href="ProxyTestIframe.php">securely</a></li>
        <li><a href="ProxyTestIframe.php">on subdomain</a></li>
        <li><a href="ProxyTestIframe.php">on main domain</a></li>
        <li><a href='ProxyTestIframe.php?visitorid=00000'>as identified visitor with visitorid=00000, visitor guest info set in GLANCE_COBROWSE</a></li>
        <li><a href='ProxyTestIframe.php?IE9Compat=1'>IE9 compatibility mode (insecure)</a></li>
        <li><a href='ProxyTestIframe.php?IE9Compat=1'>IE9 compatibility mode (secure)</a></li>
        <li><a href='ProxyTestIframe.php?IE9Compat=1&FFUserAgent=1'>IE9 compatibility mode with ff12 user agent</a></li>
        </ul>
    ...
    <span class="cssstyle4">purple</span>
    <div class="cssstyle4-relativeurl"></div>
    <div class="cssrelativeurl"></div>
    <div><img src="../images/glance3.png"/></div>
    <div><img src="proxytest2/images/glance-no-fetch.png"/></div>
    <div>Image with blob url <img id="blobimage"/></div>
